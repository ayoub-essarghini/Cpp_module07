...
int main() {
    try {
        ...
        std::cout << "Empty array size: " << emptyArray.size() << std::endl; // Expected: 0
        std::cout << "-----------------------" << std::endl;

        // Test 2: Parameterized constructor
        Array<int> intArray(5);
        std::cout << "Test 2: Parameterized Constructor" << std::endl;
        std::cout << "intArray size: " << intArray.size() << std::endl; // Expected: 5
        std::cout << "intArray elements (default initialization): ";
        for (unsigned int i = 0; i < intArray.size(); i++) {
            std::cout << intArray[i] << " "; // Expected: 0 for all
        }
        std::cout << std::endl;
        std::cout << "-----------------------" << std::endl;
        ...
        for (unsigned int i = 0; i < intArray.size(); i++) {
            std::cout << intArray[i] << " "; // Expected: 0, 2, 4, 6, 8
        }
        std::cout << std::endl;
        std::cout << "-----------------------" << std::endl;
        ...
        std::cout << "Original intArray[0]: " << intArray[0] << std::endl;  // Expected: 0
        std::cout << "Copied copiedArray[0]: " << copiedArray[0] << std::endl; // Expected: 100
        std::cout << "-----------------------" << std::endl;
        ...
        std::cout << "Original intArray[1]: " << intArray[1] << std::endl;  // Expected: 2
        std::cout << "Assigned assignedArray[1]: " << assignedArray[1] << std::endl; // Expected: 200
        std::cout << "-----------------------" << std::endl;
        ...
        try {
            ...
            std::cerr << "Exception: " << e.what() << std::endl; // Expected: Index out of bounds
        }
        std::cout << "-----------------------" << std::endl;
        ...
        std::cout << "constArray size: " << constArray.size() << std::endl; // Expected: 3
        try {
            std::cout << "constArray[1]: " << constArray[1] << std::endl; // Should work
        } catch (const std::exception& e) {
            std::cerr << "Exception: " << e.what() << std::endl;
        }
        std::cout << "-----------------------" << std::endl;

        // Test 8: Array of non-primitive types (e.g., std::string)
